...
""));
        ...
        searchBtn->setStyleSheet(QString::fromUtf8("background: #f56565; color: white;"));
        ...
        resetPwdBtn = new QPushButton(headerFrame);
        resetPwdBtn->setObjectName("resetPwdBtn");
        resetPwdBtn->setStyleSheet(QString::fromUtf8("background: #ed8936; color: white;"));

        horizontalLayout->addWidget(resetPwdBtn);
        ...
        footerFrame = new QFrame(UserPage);
    ...
    {
        titleLabel->setText(QCoreApplication::translate("UserPage", "\347\224\250\346\210\267\347\256\241\347\220\206", nullptr));
        searchEdit->setPlaceholderText(QCoreApplication::translate("UserPage", "\350\257\267\350\276\223\345\205\245\347\224\250\346\210\267\345\220\215\346\237\245\350\257\242", nullptr));
        searchBtn->setText(QCoreApplication::translate("UserPage", "\346\220\234\347\264\242", nullptr));
        addBtn->setText(QCoreApplication::translate("UserPage", "\342\236\225 \346\267\273\345\212\240\347\224\250\346\210\267", nullptr));
        editBtn->setText(QCoreApplication::translate("UserPage", "\342\234\217\357\270\217 \347\274\226\350\276\221", nullptr));
        deleteBtn->setText(QCoreApplication::translate("UserPage", "\360\237\227\221\357\270\217 \345\210\240\351\231\244", nullptr));
        resetPwdBtn->setText(QCoreApplication::translate("UserPage", "\360\237\224\204 \351\207\215\347\275\256\345\257\206\347\240\201", nullptr));
        totalLabel->setText(QCoreApplication::translate("UserPage", "\345\205\261 4 \346\235\241", nullptr));
        prevBtn->setText(QCoreApplication::translate("UserPage", "\344\270\212\344\270\200\351\241\265", nullptr));
        pageLabel->setText(QCoreApplication::translate("UserPage", "1 / 1", nullptr));
        nextBtn->setText(QCoreApplication::translate("UserPage", "\344\270\213\344\270\200\351\241\265", nullptr));
        pageSizeLabel->setText(QCoreApplication::translate("UserPage", "\346\257\217\351\241\265", nullptr));
        pageSizeCombo->setItemText(0, QCoreApplication::translate("UserPage", "20", nullptr));
        pageSizeCombo->setItemText(1, QCoreApplication::translate("UserPage", "50", nullptr));
        pageSizeCombo->setItemText(2, QCoreApplication::translate("UserPage", "100", nullptr));

        pageSizeUnit->setText(QCoreApplication::translate("UserPage", "\346\235\241", nullptr));
        (void)UserPage;
    } // retranslateUi
