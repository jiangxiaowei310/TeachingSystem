    ...
    , m_studentName(studentName)
{
    ...
    m_coursePage->setUsername(m_studentName); // 设置学号，自动加载课程
    m_gradePage = new StudentGradePage();
    m_schedulePage = new StudentSchedulePage();
    m_schedulePage->setUsername(m_studentName); // 设置学号，自动加载课表
    m_infoPage = new StudentInfoPage();
    m_infoPage->setUsername(m_studentName); // 设置学号，自动加载学生信息
