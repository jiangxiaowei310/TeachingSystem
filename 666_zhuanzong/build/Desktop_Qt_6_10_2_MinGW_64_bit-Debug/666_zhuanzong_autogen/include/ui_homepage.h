...
public:
    ...
    QPushButton *quickBtn1;
    QPushButton *quickBtn2;
...
"}"));
        ...
        quickBtn1 = new QPushButton(quickFrame);
        quickBtn1->setObjectName("quickBtn1");
        quickBtn1->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background: #4299e1;\n"
"    color: white;\n"
"    border: none;\n"
"    border-radius: 6px;\n"
...
"}"));
        ...
        gridLayout->addWidget(quickBtn1, 0, 0, 1, 1);

        quickBtn2 = new QPushButton(quickFrame);
        quickBtn2->setObjectName("quickBtn2");
        quickBtn2->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background: #48bb78;\n"
"    color: white;\n"
"    border: none;\n"
"    border-radius: 6px;\n"
...
"}"));
        ...
        gridLayout->addWidget(quickBtn2, 0, 1, 1, 1);
...
"           ", nullptr));
        ...
        quickBtn1->setText(QCoreApplication::translate("HomePage", "\346\267\273\345\212\240\345\255\246\347\224\237", nullptr));
        quickBtn2->setText(QCoreApplication::translate("HomePage", "\346\267\273\345\212\240\346\225\231\345\270\210", nullptr));
